...
class TransactionFeesApi
{
    ...
    /**
     * Operation transactionFeesGet
     *
     * Calculates and returns transaction fees for a given net amount due based on the account.
     *
     * @param  float $amount Net amount due from which to calculate the transaction fees. (required)
    ...
    {
        list($response) = $this->transactionFeesGetWithHttpInfo($amount, $impersonation_account_key, $contentType);
        return $response;
    }

    /**
     * Operation transactionFeesGetWithHttpInfo
     *
     * Calculates and returns transaction fees for a given net amount due based on the account.
     *
     * @param  float $amount Net amount due from which to calculate the transaction fees. (required)
    ...
    /**
     * Operation transactionFeesGetAsync
     *
     * Calculates and returns transaction fees for a given net amount due based on the account.
     *
     * @param  float $amount Net amount due from which to calculate the transaction fees. (required)
     ...
     */
    public function transactionFeesGetAsync($amount, $impersonation_account_key = null, string $contentType = self::contentTypes['transactionFeesGet'][0])
    {
        return $this->transactionFeesGetAsyncWithHttpInfo($amount, $impersonation_account_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation transactionFeesGetAsyncWithHttpInfo
     *
     * Calculates and returns transaction fees for a given net amount due based on the account.
     *
     * @param  float $amount Net amount due from which to calculate the transaction fees. (required)
    ...
    /**
     * Create request for operation 'transactionFeesGet'
     *
     * @param  float $amount Net amount due from which to calculate the transaction fees. (required)
     * @param  string $impersonation_account_key (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transactionFeesGet'] to see the possible values for this operation
     ...
     */
    public function transactionFeesGetRequest($amount, $impersonation_account_key = null, string $contentType = self::contentTypes['transactionFeesGet'][0])
    {

        // verify the required parameter 'amount' is set
        if ($amount === null || (is_array($amount) && count($amount) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $amount when calling transactionFeesGet'
            );
        }
