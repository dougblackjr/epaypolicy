...
class BatchesApi
{
    ...
    {
        list($response) = $this->batchesGetWithHttpInfo($page, $impersonation_account_key, $contentType);
        return $response;
    }
     ...
     */
    public function batchesGetAsync($page = null, $impersonation_account_key = null, string $contentType = self::contentTypes['batchesGet'][0])
    {
        return $this->batchesGetAsyncWithHttpInfo($page, $impersonation_account_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function batchesGetRequest($page = null, $impersonation_account_key = null, string $contentType = self::contentTypes['batchesGet'][0])
    {
