 ...
 */
class InvoiceItemModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceItemModel';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The Id of the invoice item.
     *
     * @return self
     */
