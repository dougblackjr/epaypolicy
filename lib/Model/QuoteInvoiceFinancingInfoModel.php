 ...
 */
class QuoteInvoiceFinancingInfoModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuoteInvoiceFinancingInfoModel';
    ...
    */
     ...
     *
     * @param string|null $line_of_business line_of_business
     *
     * @return self
     */
