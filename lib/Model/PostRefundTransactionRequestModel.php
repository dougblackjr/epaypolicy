 ...
 */
class PostRefundTransactionRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRefundTransactionRequestModel';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The amount to be refunded. Setting to null will process a full refund.
     *
     * @return self
     */
     ...
     * Sets send_receipt
     *
     * @param bool|null $send_receipt Set to true if an e-receipt confirmation should be sent to all parties upon a successful refund.
     *
     * @return self
     */
