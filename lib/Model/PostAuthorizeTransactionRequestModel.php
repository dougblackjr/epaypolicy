 ...
 */
class PostAuthorizeTransactionRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostAuthorizeTransactionRequestModel';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount Total amount to authorize.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount > 1E+7)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PostAuthorizeTransactionRequestModel., must be smaller than or equal to 1E+7.');
        }
