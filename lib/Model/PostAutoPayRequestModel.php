...
/**
 * PostAutoPayRequestModel Class Doc Comment
 *
 * @category Class
 * @package  Tns\\EpayPolicy
 * @author   OpenAPI Generator team
 ...
 */
class PostAutoPayRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostAutoPayRequestModel';
    ...
    protected static $setters = [
        'public_token_id' => 'setPublicTokenId',
    ...
    protected static $getters = [
        'public_token_id' => 'getPublicTokenId',
    ...
    {
        $this->setIfExists('public_token_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets public_token_id
     *
     * @return string|null
     */
    public function getPublicTokenId()
    {
        return $this->container['public_token_id'];
    }

    /**
     * Sets public_token_id
     *
     * @param string|null $public_token_id Used to reference a previously stored payment token.
     *
     * @return self
     */
    public function setPublicTokenId($public_token_id)
    {
        if (is_null($public_token_id)) {
            throw new \InvalidArgumentException('non-nullable public_token_id cannot be null');
        }
        $this->container['public_token_id'] = $public_token_id;
