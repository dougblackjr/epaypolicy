...
/**
 * PostConvertQuoteRequestModel Class Doc Comment
 *
 * @category Class
 ...
 */
class PostConvertQuoteRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostConvertQuoteRequestModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('quote_number', $data ?? [], null);
    ...
    */
     ...
     * Sets quote_number
     *
     * @param string|null $quote_number Quote Number.
     *
     * @return self
     */
    public function setQuoteNumber($quote_number)
    {
        if (is_null($quote_number)) {
            throw new \InvalidArgumentException('non-nullable quote_number cannot be null');
        }
