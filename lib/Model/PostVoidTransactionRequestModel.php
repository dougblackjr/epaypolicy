 ...
 */
class PostVoidTransactionRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostVoidTransactionRequestModel';
    ...
    */
     ...
     * Sets send_receipt
     *
     * @param bool|null $send_receipt Set to true if an e-receipt confirmation should be sent to all parties upon a successful void.
     *
     * @return self
     */
