...
/**
 * PostSendInvoiceEmailRequestModel Class Doc Comment
 *
 * @category Class
 * @package  Tns\EpayPolicy
 * @author   OpenAPI Generator team
 ...
 */
class PostSendInvoiceEmailRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostSendInvoiceEmailRequestModel';
    ...
    protected static $setters = [
        ...
        'email_to_addresses' => 'setEmailToAddresses',
    ...
    protected static $getters = [
        ...
        'email_to_addresses' => 'getEmailToAddresses',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('email_to_addresses', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_to_addresses'] === null) {
            $invalidProperties[] = "'email_to_addresses' can't be null";
        }
    ...
    /**
     * Gets email_to_addresses
     *
     * @return string
     */
    public function getEmailToAddresses()
    {
        return $this->container['email_to_addresses'];
    }

    /**
     * Sets email_to_addresses
     *
     * @param string $email_to_addresses The email addresses to whom emails to be sent.
     *
     * @return self
     */
    public function setEmailToAddresses($email_to_addresses)
    {
        if (is_null($email_to_addresses)) {
            throw new \InvalidArgumentException('non-nullable email_to_addresses cannot be null');
        }
        $this->container['email_to_addresses'] = $email_to_addresses;
     ...
     * Sets email_message
     *
     * @param string|null $email_message Email Message.
     *
     * @return self
     */
